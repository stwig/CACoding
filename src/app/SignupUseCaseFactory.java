...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createClearUseCase(userDataAccessObject, clearViewModel);
    ...
    private static ClearController createClearUseCase(SignupUserDataAccessInterface userDataAccessObject, ClearViewModel clearViewModel){
        ClearOutputBoundary clearOutputBoundary = new ClearPresenter(clearViewModel);
        ClearInputBoundary clearInputBoundary = new ClearInteractor((ClearUserDataAccessInterface) userDataAccessObject, clearOutputBoundary);
